...
local RunBot = io.open("CARLOS", 'w')
RunBot:write([[
#!/usr/bin/env bash
cd $HOME/CARLOS
token="]]..database:get(Server_Done.."Token_Write")..[["
rm -fr CARLOS.lua
wget "https://raw.githubusercontent.com/CARLOSTEAM/CARLOS/main/CARLOS.lua"
while(true) do
rm -fr ../.telegram-cli
./tg -s ./CARLOS -p PROFILE --bot=$token
done
]])
RunBot:close()
