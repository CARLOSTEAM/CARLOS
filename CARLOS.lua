...
Text = "W𝙀𝙇𝘾𝙊𝙈𝙀𝙏𝙊 CARLOSTEAM\n\n[❏  CARLOSTEAM](http://t.me/CARLOSTEAMM)\n\n[❏   𝙄𝙉𝙁𝙊 𝙎𝙊𝙐𝙍𝘾𝙀 ](http://t.me/CARLOSTEAMM)\n\n[❏  𝘾𝘼𝙍𝙇𝙊𝙎𝙊𝙋𝙀𝙍](http://t.me/D9l9l)\n\n[❏   𝘽𝙊𝙏 𝘾𝘼𝙍𝙇𝙊𝙎](http://t.me/D9l9l)"
keyboard = {} 
keyboard.inline_keyboard = {
...
{{text = '𝘾𝘼𝙍𝙇𝙊𝙎 𝐓𝐄𝐀𝐌', url="t.me/CARLOSTEAMM"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
{{text = '𝙎𝙊𝙐𝙍𝘾𝙀 𝘾𝘼𝙍𝙇𝙊𝙎 ',url='http://t.me/CARLOSTEAMM'}},
}
...
{{text = '⓽', callback_data="/help9"},{text = '⓵⓪', callback_data="/help10"}},
{{text = 'الاوامر الرئيسيه', callback_data="/help"}},
{{text = '-𝘾𝘼𝙍𝙇𝙊𝙎 𝐓E𝐀𝐌', url="t.me/CARLOSTEAMM"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
inline = {
{{text = 'sᴏᴜʀᴄʀ ʙʀᴀɴᴅ',url='http://t.me/CARLOSTEAMM'}},
}
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
