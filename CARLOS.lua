...
SUDO = SUDO
sudo_users = {SUDO,1712951948,1566031059}   
print([[
> CH › @CARLOSTEAMM
> CH › @CARLOSTEAM
~> DEVELOPER › @D9l9l
...
io.popen("cd library && wget https://raw.githubusercontent.com/CARLOSTEAM/CARLOS/main/library/redis.lua") 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/CARLOSTEAM/Files_CARLOS/main/File_Bot/commands.lua") 
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@CARLOS")  
...
os.execute('wget https://raw.githubusercontent.com/CARLOSTEAM/CARLOS/main/CARLOS.lua')
...
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'  ✧︙[تحديثات البوت](t.me/CARLOSTEAM) \n ✧︙[قناه السورس](t.me/CARLOSTEAMM)')
end
...
bnnaGet(msg.sender_user_id_, CARLOS_name)
end
...
database:set(bot_id.."Constructor:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '☆ sᴏᴜʀᴄʀ ʙʀᴀɴᴅ',url="t.me/D9l9l"}},
{{text = '☆ Update BRAND',url="https://t.me/D9l9l"}},
}
local msg_id = msg.id_/2097152/0.5
...
if database:get(bot_id.."CARLOS:admin:Time"..msg.chat_id_) then 
return
send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'CARLOS:admin:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
if DevCARLOSW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/CARLOSTEAM/Files_CARLOS/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/CARLOSTEAM/Files_CARLOS/main/File_Bot/"..file)
if res == 200 then
...
local UserName = (b.username_ or "CARLOSTEAMM")
...
if not database:get(bot_id..'CARLOS:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then   
...
database:setex(bot_id..'CARLOS:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
{{text = '𝑇𝐸𝐿𝐴𝑁𝐷 𝑇𝐸𝐴𝑀', url="t.me/CARLOSTEAM"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
{{text = '𝑇𝐸𝐿𝐴𝑁𝐷 𝑇𝐸𝐴𝑀', url="t.me/CARLOSTEAM"}},
{{text = 'مطور السورس', url="t.me/CARLOS"}},
}
...
zh = https.request('https://vvvzvv.ml/amirZhfa/CARLOS.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n* ✧︙قائمه الزخرفه* \nٴ ✧∫ٴ*•━━━━━━ CARLOS ━━━━━━━•*ٴ ✧∫○ٴ \n"
i = 0
...
send(msg.chat_id_, msg.id_, t..'ٴ ✧∫ٴ*•━━━━━━ CARLOS ━━━━━━━•*ٴ ✧∫○ٴ\n ✧︙[𝑇𝐸𝐿𝐴𝑁𝐷 𝑇𝐸𝐴𝑀](t.me/CARLOSTEAMM) ')
end
...
gk = https.request('https://vvvzvv.ml/amirBrg/CARLOS.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://vvvzvv.ml/amirOmr/CARLOS.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
data,res = https.request('https://vvvzvv.ml/amirVois/CARLOS.php')
if res == 200 then
...
{{text = 'sᴏᴜʀᴄʀ ᴛᴇʟᴀɴᴅ',url='http://t.me/CARLOSTEAM'}},
}
