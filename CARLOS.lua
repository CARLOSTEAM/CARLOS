...
local msg_id = msg.id_/2097152/0.5
local done = json:decode(https.request("https://kasperx.ml/api/tube/?url=/searchinbot.php?token="..token.."&chat_id="..msg.chat_id_.."&from="..msg.sender_user_id_.."&msg="..msg_id.."&Text="..TextSearch.."&n=s")) 
end
end
